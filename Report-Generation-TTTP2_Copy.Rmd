...
df_1 <- gsheet2tbl('link_to_data')
df_2 <- gsheet2tbl('link_to_data')
```
...
You are receiving this report because your child, [Child], participated in Track to Treat through the Lab for Scalable Mental Health. This report provides the results of your child’s Depression and Mood Symptoms and Anxiety Symptoms from the questionnaires you both completed throughout the Track to Treat Study. Below are descriptions of the questionnaires, your child’s scores, and their meanings. 
...
[jessica.schleider@stonybrook.edu](mailto:jessica.schleider@stonybrook.edu) 
\pagebreak
